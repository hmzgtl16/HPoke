...
class DaosTest : DatabaseTest() {
    ...
    @Test
    fun testInsertSinglePokemon() = runTest {
    ...
    @Test
    fun testInsertPokemonWithNullValues() = runTest {
        val sprites = SpritesEntity(
            id = 1,
            frontDefault = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/1.png",
            frontShiny = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/shiny/1.png"
    ...
    @Test
    fun testInsertMultiplePokemons() = runTest {
        val sprites = listOf(
            SpritesEntity(
                id = 1,
                frontDefault = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/1.png",
    ...
    @Test
    fun testInsertMultiplePokemonsWithNullFields() = runTest {
        val sprites = listOf(
            SpritesEntity(
                id = 1,
                frontDefault = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/1.png",
    ...
    @Test
    fun testGetPokemonByIdNotFound() = runTest {
    ...
    @Test
    fun testGetPokemonByIdMultipleTimes() = runTest {
        val sprites = SpritesEntity(
            id = 1,
            frontDefault = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/1.png",
            frontShiny = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/shiny/1.png"
    ...
    @Test
    fun testGetAllPokemons() = runTest {
        val sprites = listOf(
            SpritesEntity(
                id = 1,
                frontDefault = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/1.png",
    ...
    @Test
    fun testReplacePokemonWithSameId() = runTest {
        val sprites = SpritesEntity(
            id = 1,
            frontDefault = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/1.png",
            frontShiny = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/shiny/1.png"
    ...
    @Test
    fun testInsertPokemonWithSingleType() = runTest {
        val sprites = SpritesEntity(
            id = 25,
    ...
    @Test
    fun testInsertPokemonWithMultipleTypes() = runTest {
        val sprites = SpritesEntity(
            id = 55,
            frontDefault = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/1.png",
            frontShiny = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/shiny/1.png"
    ...
    @Test
    fun testInsertPokemonWithSingleAbility() = runTest {
        val sprites = SpritesEntity(
            id = 1,
            frontDefault = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/1.png",
            frontShiny = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/shiny/1.png"
        ...
        pokemonDao.insertPokemonAbilityCrossRefs(
            listOf(
                element = PokemonAbilityCrossRef(
                    pokemonId = 1,
                    abilityId = 65,
                    isHidden = false,
                    slot = 1
    ...
    @Test
    fun testInsertPokemonWithMultipleAbilities() = runTest {
        val sprites = SpritesEntity(
            id = 1,
            frontDefault = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/1.png",
            frontShiny = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/shiny/1.png"
        ...
        pokemonDao.insertPokemonAbilityCrossRefs(
            refs = listOf(
                PokemonAbilityCrossRef(pokemonId = 1, abilityId = 65, isHidden = false, slot = 1),
                PokemonAbilityCrossRef(pokemonId = 1, abilityId = 34, isHidden = true, slot = 2)
            )
        )
    ...
    @Test
    fun testInsertPokemonWithAllStats() = runTest {
        val sprites = SpritesEntity(
            id = 1,
            frontDefault = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/1.png",
            frontShiny = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/shiny/1.png"
